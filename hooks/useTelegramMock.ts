      ...
      const initDataRaw = new URLSearchParams([
        [
          ...
          JSON.stringify({
            ...
            is_premium: true,
            language_code: "en",
            last_name: "Eriklintsev",
            username: "ilerik",
          }),
        ],
        [
          "hash",
          "93ca38f5092ad892ff4eac7beea0f4e2d87404c090f45a4ae79b200c02bdd1b0",
        ],
        ["auth_date", "1727006245"], // 2024-09-22T11:57:25.000Z
        ["start_param", "zY0gcAMoNfUUPHz1VG3w"], // clan id
        ["chat_type", "supergroup"],
        ["chat_instance", "5190927634621162745"],
      ]).toString();
